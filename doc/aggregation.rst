...
for aggregation involving **boolean**, **integer** and **float**.
Support for string, date and datetime columns might be added later. If
Numba is not available, Dataiter will automatically fall back on the
